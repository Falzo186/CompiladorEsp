...
$env:CLASSPATH = "C:\antlr\antlr-4.13.0-complete.jar;$repoRoot\build\classes"

# Verificar que existan los archivos
Write-Host "[2/6] Verificando archivos..." -ForegroundColor Yellow
if (-not (Test-Path "build\classes\com\compilador\ej\lexer\LexerMain.class")) {
    Write-Host "❌ ERROR: Clases compiladas no encontradas" -ForegroundColor Red
    Write-Host "Debes compilar primero:" -ForegroundColor Red
    Write-Host "  .\bin\compilar.bat" -ForegroundColor Red
    exit 1
}
...
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host "Ejecutando: java -cp build\\classes;C:\antlr\antlr-4.13.0-complete.jar com.compilador.ej.lexer.LexerMain resources/examples/caso1_basico.ej" -ForegroundColor White
Write-Host ""
$output1 = java -cp "build\classes;C:\antlr\antlr-4.13.0-complete.jar" com.compilador.ej.lexer.LexerMain resources\examples\caso1_basico.ej
Write-Host $output1
...
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host "Ejecutando: java -cp build\\classes;C:\antlr\antlr-4.13.0-complete.jar com.compilador.ej.lexer.LexerMain resources/examples/caso2_matematicas.ej" -ForegroundColor White
Write-Host ""
$output2 = java -cp "build\classes;C:\antlr\antlr-4.13.0-complete.jar" com.compilador.ej.lexer.LexerMain resources\examples\caso2_matematicas.ej
Write-Host $output2
...
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host "Ejecutando: java -cp build\\classes;C:\antlr\antlr-4.13.0-complete.jar com.compilador.ej.lexer.LexerMain resources/examples/caso3_estres.ej" -ForegroundColor White
Write-Host ""
$output3 = java -cp "build\classes;C:\antlr\antlr-4.13.0-complete.jar" com.compilador.ej.lexer.LexerMain resources\examples\caso3_estres.ej
Write-Host $output3
...
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host "Ejecutando: java -cp build\\classes;C:\antlr\antlr-4.13.0-complete.jar com.compilador.ej.lexer.LexerMain resources/examples/caso4_errores.ej" -ForegroundColor White
Write-Host ""
$output4 = java -cp "build\classes;C:\antlr\antlr-4.13.0-complete.jar" com.compilador.ej.lexer.LexerMain resources\examples\caso4_errores.ej
Write-Host $output4
...
Write-Host "╚════════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host "Ejecutando: java -cp build\\classes;C:\antlr\antlr-4.13.0-complete.jar com.compilador.ej.lexer.LexerMain resources/examples/caso5_completo.ej" -ForegroundColor White
Write-Host ""
$output5 = java -cp "build\classes;C:\antlr\antlr-4.13.0-complete.jar" com.compilador.ej.lexer.LexerMain resources\examples\caso5_completo.ej
Write-Host $output5
